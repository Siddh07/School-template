    ...
    <div>
      ...
      <section className="p-8 bg-gray-100">
        <div className="grid grid-cols-1 md:grid-cols-2 md:mt-32 my-4 md:mr-32 md:ml-32">
          ...
          <div className="bg-indigo-600 text-gray-100 shadow justiify-center text-center p-6 md:py-12 md:px-16">
          ...
          <div className="bg-indigo-600 text-gray-100 shadow justiify-center text-center p-6 md:px-16 md:py-20">
