  ...
  return (
    <div className="mx-auto max-w-6xl p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {posts.map(post => (
          <a key={post.postId} href="/news" className="bg-white p-4 shadow-md rounded-md hover:bg-gray-100 transition duration-150 ease-in-out transform hover:-translate-y-1 hover:scale-105 block">
