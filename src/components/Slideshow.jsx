    ...
    <div className="container mx-auto py-8">
      ...
      {images.length > displayedImages && (
        <div className="flex justify-center mt-4">
          <button onClick={handleViewMore} className="mt-8 px-4 py-2 border-2 bg-indigo-600 text-white hover:border-indigo-600 hover:text-indigo-600 rounded hover:bg-gray-100 transition duration-500">
            View More
          </button>
        </div>
      )}
